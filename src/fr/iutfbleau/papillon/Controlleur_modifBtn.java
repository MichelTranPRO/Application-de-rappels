...
/**
 * La classe <code>Controlleur_modifBtn</code> est utilisée 
...
public class Controlleur_modifBtn implements MouseListener{
    ...
    /**
     * Le constructeur de la classe <code>Controlleur_modifBtn</code> 
     ...
     */
	public Controlleur_modifBtn(Bouton bouton){
        this.bouton=bouton;
	}
